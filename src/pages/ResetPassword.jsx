    ...
    const onSubmit = async (data) => {
      ...
      if (data.newpassoword === data.Confirmpassword) {
        try {
          ...
          // });http://dev.api-server.com:5020/api/password/reset?token=c23026cd-4e0f-4e5d-aaeb-1004e4cdeb52
          const response = await axios.post(`${process.env.REACT_APP_API_URL}/password/reset?token=${token}`, postData).then(()=>{
